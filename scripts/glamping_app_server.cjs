...
async function serveStatic(reqUrl, res) {
  if (["/", "/view", "/admin", "/b2b"].includes(reqUrl.pathname)) {
    ...
    const publicHtml = html
      .replace('href="/styles.css"', 'href="/styles.css?v=v2-20260822-company-db-explorer-v34"')
      .replace('href="/admin-theme.css"', 'href="/admin-theme.css?v=v2-20260822-company-db-explorer-v34"')
      .replace('src="/app.js"', 'src="/app.js?v=v2-20260822-company-db-explorer-v34"');
