...
async function serveStatic(reqUrl, res) {
  if (reqUrl.pathname === "/" || reqUrl.pathname === "/view") {
    ...
    const publicHtml = html
      .replace('href="/styles.css"', 'href="/styles.css?v=v2-20260703-sales-gate-revenue-evidence"')
      .replace('src="/app.js"', 'src="/app.js?v=v2-20260703-sales-gate-revenue-evidence"');
