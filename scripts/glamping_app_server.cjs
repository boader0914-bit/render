...
async function serveStatic(reqUrl, res) {
  if (["/", "/view", "/admin", "/b2b"].includes(reqUrl.pathname)) {
    ...
    const publicHtml = html
      .replace('href="/styles.css"', 'href="/styles.css?v=v2-20260711-admin-quick-correction-flow"')
      .replace('src="/app.js"', 'src="/app.js?v=v2-20260711-admin-quick-correction-flow"');
