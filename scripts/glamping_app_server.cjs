...
async function serveStatic(reqUrl, res) {
  if (["/", "/view", "/admin", "/b2b"].includes(reqUrl.pathname)) {
    ...
    const publicHtml = html
      .replace('href="/styles.css"', 'href="/styles.css?v=datalab-20260829-sancheong-diagnostic-v69"')
      .replace('href="/admin-theme.css"', 'href="/admin-theme.css?v=datalab-20260829-sancheong-diagnostic-v69"')
      .replace('src="/app.js"', 'src="/app.js?v=datalab-20260829-sancheong-diagnostic-v69"');
