...
async function serveStatic(reqUrl, res) {
  if (["/", "/view", "/admin", "/b2b"].includes(reqUrl.pathname)) {
    ...
    const publicHtml = html
      .replace('href="/styles.css"', 'href="/styles.css?v=v2-20260710-admin-region-audit-filters"')
      .replace('src="/app.js"', 'src="/app.js?v=v2-20260710-admin-region-audit-filters"');
