...
const expectedAssetVersion = "v2-20260804-detail-sheet-v40";
...
assert.match(server, /const UI_ASSET_VERSION = "v2-20260804-detail-sheet-v40";/, "server must enforce the current UI asset version");
assert.match(serviceWorker, /const UI_ASSET_VERSION = "v2-20260804-detail-sheet-v40";/, "service worker must share the current UI asset version");
