...
const expectedAssetVersion = "v2-20260807-worker-top20-ui-v46";
...
assert.match(server, /const UI_ASSET_VERSION = "v2-20260807-worker-top20-ui-v46";/, "server must enforce the current UI asset version");
assert.match(serviceWorker, /const UI_ASSET_VERSION = "v2-20260807-worker-top20-ui-v46";/, "service worker must share the current UI asset version");
assert.match(serviceWorker, /const CACHE_VERSION = "lodging-datalab-pwa-v20260807-worker-top20-ui-v46";/, "service worker cache must rotate with the UI release");
