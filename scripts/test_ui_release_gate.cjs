...
const expectedAssetVersion = "v2-20260810-top20-artifact-projection-v49";
...
assert.match(server, /const UI_ASSET_VERSION = "v2-20260810-top20-artifact-projection-v49";/, "server must enforce the current UI asset version");
assert.match(serviceWorker, /const UI_ASSET_VERSION = "v2-20260810-top20-artifact-projection-v49";/, "service worker must share the current UI asset version");
assert.match(serviceWorker, /const CACHE_VERSION = "lodging-datalab-pwa-v20260810-top20-artifact-projection-v49";/, "service worker cache must rotate with the UI release");
