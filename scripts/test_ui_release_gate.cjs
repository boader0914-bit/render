...
const expectedAssetVersion = "v2-20260803-ui-release-v33";
...
assert.match(server, /const UI_ASSET_VERSION = "v2-20260803-ui-release-v33";/, "server must enforce the current UI asset version");
assert.match(serviceWorker, /const UI_ASSET_VERSION = "v2-20260803-ui-release-v33";/, "service worker must share the current UI asset version");
assert.match(serviceWorker, /const CACHE_VERSION = "lodging-datalab-pwa-v20260803-ui-release-v33";/, "service worker cache must rotate with the UI release");
